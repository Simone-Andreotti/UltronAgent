...
& codex app --config 'model="gpt-5.6-terra"' --config 'model_reasoning_effort="high"' --config 'model_verbosity="low"' --config "developer_instructions=$encodedInstructions" $WorkingDirectory
exit $LASTEXITCODE