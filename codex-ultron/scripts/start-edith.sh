...
printf '%s\n' "Edith at your service."
exec codex --profile edith --model gpt-5.6-luna --config 'model_reasoning_effort="xhigh"' $live_search_flag $full_access_flag $sandbox_mode_args "$@"
